...
--------- | -----------
[`docstring-inheritance`](docstring-inheritance.md) | A more advanced docstring inheritance utility that also provides a Griffe extension.
...
[`fieldz`](fieldz.md) | Support for data-class like objects (dataclasses, pydantic, attrs, etc.) using [fieldz](https://github.com/pyapp-kit/fieldz).
[`generics`](generics.md) | Resolve generic type parameters as bound types in subclasses.
[`inherited-method-crossrefs`](inherited-method-crossrefs.md) | Replace docstrings of inherited methods with cross-references to parents.
[`modernized-annotations`](modernized-annotations.md) | Modernize type annotations by adopting PEP 585 and PEP 604.
