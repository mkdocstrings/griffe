...
- :material-cube-scan:{ .lg .middle } **Loading**
    ...
    [:octicons-arrow-right-24: Learn how to load data](loading.md)
...
- :material-navigation-variant-outline:{ .lg .middle } **Navigating**
    ...
    [:octicons-arrow-right-24: Learn how to navigate data](navigating.md)
...
- :material-code-json:{ .lg .middle } **Serializing**
    ...
    [:octicons-arrow-right-24: Learn how to serialize data](serializing.md)
...
- :material-target:{ .lg .middle } **Checking**
    ...
    [:octicons-arrow-right-24: Learn how to detect and handle breaking changes](checking.md)
...
- :material-puzzle-plus:{ .lg .middle } **Extending**
    ...
    [:octicons-arrow-right-24: Learn how to write and use extensions](extending.md)
...
- :material-gift-open:{ .lg .middle } **Public API**
    ...
    [:octicons-arrow-right-24: See our public API recommendations](recommendations/public-apis.md)
...
- :material-star-face:{ .lg .middle } **Python code best practices**
    ...
    [:octicons-arrow-right-24: See our best practices](recommendations/python-code.md)
...
- :material-text:{ .lg .middle } **Docstrings**
    ...
    [:octicons-arrow-right-24: See our docstring recommendations](recommendations/docstrings.md)
...
-   :octicons-ai-model-24:{ .lg .middle } **Parse docstrings**
    ...
    [:octicons-arrow-right-24: See how to parse docstrings](how-to/parse-docstrings.md)
...
-   **@ Support custom decorators**
    ...
    [:octicons-arrow-right-24: See how to support custom decorators](how-to/support-decorators.md)
...
-   :material-select:{ .lg .middle } **Selectively inspect objects**
    ...
    [:octicons-arrow-right-24: See how to selectively inspect objects](how-to/selectively-inspect.md)
...
-   :material-bow-tie:{ .lg .middle } **Set objects' docstring style**
    ...
    [:octicons-arrow-right-24: See how to set the correct docstring styles on objects](how-to/set-docstring-styles.md)
...
-   :simple-git:{ .lg .middle } **Set Git source info on objects**
    ...
    [:octicons-arrow-right-24: See how to set the correct Git information or source link on objects](how-to/set-git-info.md)
