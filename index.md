...
- **Getting started**
  ...
  [Installation](https://mkdocstrings.github.io/griffe/installation/index.md) [Introduction](https://mkdocstrings.github.io/griffe/introduction/index.md)
...
- **Deep dive**
  ...
  [Guide](https://mkdocstrings.github.io/griffe/guide/users/index.md) [API reference](https://mkdocstrings.github.io/griffe/reference/api/index.md)
...
[Playground](https://mkdocstrings.github.io/griffe/playground/index.md) [Join our Gitter channel](https://app.gitter.im/#/room/#mkdocstrings_griffe:gitter.im)
