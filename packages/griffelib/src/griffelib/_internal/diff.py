...
from griffelib._internal.enumerations import BreakageKind, ExplanationStyle, ParameterKind
from griffelib._internal.exceptions import AliasResolutionError
from griffelib._internal.git import _WORKTREE_PREFIX
from griffelib._internal.logger import logger

if TYPE_CHECKING:
    from collections.abc import Iterable, Iterator

    from griffelib._internal.models import Alias, Attribute, Class, Function, Object
...
def find_breaking_changes(
    ...
    Examples:
        >>> import sys, griffelib
        >>> new = griffelib.load("pkg")
        >>> old = griffelib.load_git("pkg", "1.2.3")
        >>> for breakage in griffelib.find_breaking_changes(old, new)
