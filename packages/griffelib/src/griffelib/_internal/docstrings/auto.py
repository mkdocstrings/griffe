...
if TYPE_CHECKING:
    from griffelib._internal.docstrings.google import GoogleOptions
    from griffelib._internal.docstrings.models import DocstringSection
    from griffelib._internal.docstrings.numpy import NumpyOptions
    from griffelib._internal.docstrings.parsers import DocstringStyle
    from griffelib._internal.docstrings.sphinx import SphinxOptions
    from griffelib._internal.models import Docstring
