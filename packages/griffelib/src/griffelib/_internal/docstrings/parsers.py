...
from griffelib._internal.docstrings.auto import AutoOptions, parse_auto
from griffelib._internal.docstrings.google import GoogleOptions, parse_google
from griffelib._internal.docstrings.models import DocstringSection, DocstringSectionText
