...
from griffelib._internal.enumerations import LogLevel, ParameterKind
from griffelib._internal.exceptions import NameResolutionError
...
if TYPE_CHECKING:
    ...
    from griffelib._internal.models import Class, Function, Module
...
class Expr:
    ...
    def canonical_name(self) -> str:
        ...
        # We must handle things like `griffelib.Visitor` and `griffelib.Visitor(code)`.
