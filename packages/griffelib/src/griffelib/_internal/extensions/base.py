...
from griffelib._internal.agents.nodes.ast import ast_children, ast_kind
from griffelib._internal.exceptions import ExtensionNotLoadedError
...
if TYPE_CHECKING:
    ...
    from griffelib._internal.agents.inspector import Inspector
    from griffelib._internal.agents.nodes.runtime import ObjectNode
    from griffelib._internal.agents.visitor import Visitor
    from griffelib._internal.loader import GriffeLoader
