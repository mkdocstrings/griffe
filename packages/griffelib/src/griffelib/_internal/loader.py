...
from griffelib._internal.agents.inspector import inspect
from griffelib._internal.agents.visitor import visit
from griffelib._internal.collections import LinesCollection, ModulesCollection
from griffelib._internal.enumerations import Kind
...
from griffelib._internal.expressions import ExprName
from griffelib._internal.extensions.base import Extensions, load_extensions
from griffelib._internal.finder import ModuleFinder, NamespacePackage, Package
from griffelib._internal.git import GitInfo, _tmp_worktree
...
from griffelib._internal.models import Alias, Module, Object
...
if TYPE_CHECKING:
    ...
    from griffelib._internal.enumerations import Parser
...
class GriffeLoader:
    ...
    def load(
        ...
        *,
        ...
        Examples:
            >>> loader.load("griffelib.Module")
            Alias("Module", "griffelib._internal.models.Module")
            ...
            if submodule_name in parent_module.members:
                ...
                if member.is_alias or not member.is_module:
                    logger.debug(
                        ...
                        "see https://mkdocstrings.github.io/griffelib/best_practices/#avoid-member-submodule-name-shadowing.",
                        submodule.path,
                    )
...
def load(
    ...
    *,
    ...
    Example:
        ...
        module = griffelib.load(...)
        ```

        This is a shortcut for:

        ```python
        from griffelib import GriffeLoader
...
def load_git(
    ...
    *,
    ...
    Examples:
        ```python
        from griffelib import load_git
