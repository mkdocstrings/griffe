...
from griffelib._internal.exceptions import AliasResolutionError, BuiltinModuleError, CyclicAliasError
from griffelib._internal.merger import merge_stubs

if TYPE_CHECKING:
    from collections.abc import Sequence

    from griffelib._internal.models import Alias, Attribute, Class, Function, Module, Object, TypeAlias
...
class SerializationMixin:
    ...
    def as_json(self, *, full: bool = False, **kwargs: Any) -> str:
        ...
        Returns:
            A JSON string.
        """
        from griffelib._internal.encoders import JSONEncoder  # Avoid circular import.  # noqa: PLC0415
    ...
    def from_json(cls: type[_ObjType], json_string: str, **kwargs: Any) -> _ObjType:  # noqa: PYI019
        ...
        """
        from griffelib._internal.encoders import json_decoder  # Avoid circular import.  # noqa: PLC0415
