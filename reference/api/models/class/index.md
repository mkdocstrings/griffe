...
- ## **`keywords`**
  ...
  (`dict[str, Any] | None`, default: `None` ) – The class keywords arguments, if any.
...
- **`keywords`** (`dict[str, Any]`) – The class keywords arguments.
...
Source code in `packages/griffelib/src/griffe/_internal/c3linear.py`
